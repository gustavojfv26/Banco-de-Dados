...
--
-- Banco de dados: `gustavo_financeiro`
--
CREATE DATABASE IF NOT EXISTS `gustavo_financeiro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `gustavo_financeiro`;
...
(1, 'Gustavo Joaquim Ferreira do Vale', '023.456.789-10'),
